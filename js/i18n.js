...
const translations = {
    ...
    it: {
        ...
        tipRecommendBadge: "Conviene puntare sul passaporto: con {abNeeded} AB raggiungi la soglia dei badge che sblocca il bonus +{percent}%, circa {gainFormatted} di rendita giornaliera in più — più efficiente dei terreni in questo momento.",
    ...
    en: {
        ...
        tipRecommendBadge: "The passport is the better move right now: {abNeeded} AB gets you to the badge threshold that unlocks the +{percent}% bonus, about {gainFormatted} more daily income — more efficient than lands at the moment.",
