...
const translations = {
    ...
    it: {
        ...
        tipRecommendLand: "💰 Conviene puntare sui terreni: ogni {abCost} AB investiti ti danno circa {gainFormatted} di rendita giornaliera in più — al momento è l'opzione più efficiente rispetto ai badge.",
        tipRecommendBadge: "🎖️ Conviene puntare sul passaporto: con {abNeeded} AB raggiungi la soglia dei badge che sblocca il bonus +{percent}%, circa {gainFormatted} di rendita giornaliera in più — più efficiente dei terreni in questo momento.",
        tipGoalIncomeReached: "🎉 Hai già raggiunto il tuo obiettivo di rendita ({targetFormatted}/giorno)! Puoi impostarne uno più ambizioso dal pannello ✏️.",
        ...
        tipGoalLandsReached: "🎉 Hai già raggiunto il tuo obiettivo di {target} terreni! Impostane uno nuovo dal pannello ✏️ per continuare a monitorare i progressi.",
        ...
        tipRarity: "Sulla mappa, quando puoi scegliere tra più terreni disponibili, un Legendary rende circa {mult}x un Common allo stesso costo ({cost} AB): scegli sempre la rarità più alta visibile.",
        tipMayorStrategy: "🏛️ Diventare mayor richiede più terreni di chiunque altro in quella specifica città: prima di accumulare terreni ovunque, valuta se conviene concentrarti su una città con pochi giocatori attivi, dove superare l'attuale mayor costa meno.",
        ...
        abTipMinigames: "🕹️ Mini-giochi disponibili: Atlas Golf, Atlas Warship, Atlas Bowling, Atlas Racer, Atlas Fishing — altra fonte di AB oltre all'Arcade.",
    ...
    en: {
        ...
        tipRecommendLand: "💰 Lands are the better move right now: every {abCost} AB invested gets you about {gainFormatted} more daily income — more efficient than badges at the moment.",
        tipRecommendBadge: "🎖️ The passport is the better move right now: {abNeeded} AB gets you to the badge threshold that unlocks the +{percent}% bonus, about {gainFormatted} more daily income — more efficient than lands at the moment.",
        tipGoalIncomeReached: "🎉 You've already reached your income goal ({targetFormatted}/day)! You can set a more ambitious one from the ✏️ panel.",
        ...
        tipGoalLandsReached: "🎉 You've already reached your goal of {target} lands! Set a new one from the ✏️ panel to keep tracking your progress.",
        ...
        tipRarity: "On the map, when you can choose between multiple available lands, a Legendary earns about {mult}x a Common one at the same cost ({cost} AB): always pick the highest rarity visible.",
        tipMayorStrategy: "🏛️ Becoming mayor requires owning more lands than anyone else in that specific city: before buying lands everywhere, consider focusing on a city with few active players, where overtaking the current mayor costs less.",
        ...
        abTipMinigames: "🕹️ Available mini-games: Atlas Golf, Atlas Warship, Atlas Bowling, Atlas Racer, Atlas Fishing — another AB source besides Arcade.",
